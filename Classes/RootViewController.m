...
- (void)viewDidLoad {
	...
	CLLocationManager *locationManager = [RoutesyBARTAppDelegate sharedLocationManager];  //Link to the appDelegate
	...
	[[BARTPredictionLoader sharedBARTPredictionLoader] loadPredictionXML:self];  //Link to a method in BARTPredictionLoader
}

- (void)xmlDidFinishLoading { //BartPredictionLoader.h protocol is implemented here!!!
