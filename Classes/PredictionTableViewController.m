...
- (void)viewWillAppear:(BOOL)animated {
	...
	self.predictions = [[BARTPredictionLoader sharedBARTPredictionLoader] predictionsForStation:self.station.stationId]; //singleton ref. Returns an array of predictions based on our unique Station ID.
